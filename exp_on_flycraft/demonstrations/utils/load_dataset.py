...
def load_data_from_csv_files(
        ...
        env_config_file: Path=PROJECT_ROOT_DIR / "configs" / "env" / "env_config_for_ppo.json",
...
if __name__ =="__main__":
    ...
    data_dir = PROJECT_ROOT_DIR / args.data_dir
    cache_data = True
    cache_data_dir = PROJECT_ROOT_DIR / args.cache_dir
